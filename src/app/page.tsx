...
export default function Home() {
  ...
  const login = async () => {
    try {
      const response = await fetch("/openapi/v1/user/loginByPassword", {
        method: "POST",
        headers: {
        ...
        <main className="pt-16">
                  ...
                  <div className="p-6 md:p-8 flex justify-center">
                    <div className="max-w-xs">
                      <p className="text-sm font-normal text-gray-700 mt-1">
                        通过Multi Agent + AgenticRAG
                      </p>
                      <p className="text-sm font-normal text-gray-700 mt-1">
                        接管企业95%的基础咨询，降低95%TCO
                      </p>
                    </div>
                  </div>
                  <div className="p-6 md:p-8 flex justify-center">
                    <div className="max-w-xs">
                      <p className="text-sm font-normal text-gray-700 mt-1">
                        快速对接企业内部系统，企业可以自由部署工作流，快速上线新业务
                      </p>
                    </div>
                  </div>
                  <div className="p-6 md:p-8 flex justify-center">
                          ...
                          <div className="flex flex-1">
                            <div className="w-1/4 bg-gray-100 p-2">
                              <div className="bg-blue-600 text-white text-[10px] p-2 rounded mb-1 flex items-center justify-between">
                                <span>服务中的客户</span>
                                <span className="bg-blue-800 px-1 rounded">
                                  12
                                </span>
                              </div>
                              ...
                              <div className="flex flex-col space-y-2">
                                <div className="bg-purple-100 rounded p-2">
                                  <div className="flex justify-between items-center mb-1">
                                    ...
                                    <span className="bg-gray-200 text-gray-700 text-[10px] px-2 py-0.5 rounded">
                                      处理中
                                    </span>
                                  </div>
                            ...
                            <div className="w-1/3 p-2 bg-white">
                              ...
                              <div className="bg-purple-50 rounded-lg p-2 mb-2">
                                <div className="text-[10px] text-gray-700 mb-1 font-medium">
                                  建议操作
                                </div>
                              ...
                              <div className="relative h-12">
                                <div className="absolute inset-0 flex items-end">
                                  <div className="h-[60%] w-1/6 bg-blue-200 relative">
                                    <div className="absolute -top-3 w-full text-center text-[8px] text-blue-700">
                                      186
                                    </div>
                                  </div>
              ...
              <div className="group bg-white rounded-2xl p-8 hover:shadow-xl transition-all duration-300 border border-gray-200 relative overflow-hidden card-hover">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    <div
                      key={index}
                      className="bg-gray-50 rounded-lg p-4 group-hover:bg-blue-50 transition-colors border border-gray-100"
                    >
            ...
            <div className="max-w-6xl mx-auto px-4 mb-16">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-red-50 rounded-2xl p-8 border border-red-200 shadow-sm">
                  <div className="text-xl font-semibold text-red-700 mb-6">
                    不应该是
                  </div>
            ...
            <div className="max-w-6xl mx-auto px-4">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-orange-50 rounded-2xl p-8 border border-orange-200 shadow-sm">
                  <div className="text-xl font-semibold text-orange-700 mb-6">
                    应该是
                  </div>
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
          ...
          <section className="py-20 relative bg-gray-50" id="limitations">
            ...
            <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-3 gap-8">
              ...
              <div className="group bg-white rounded-2xl p-8 hover:shadow-lg transition-all duration-300 border border-gray-200 card-hover">
                  ...
                  <div className="relative w-12 h-12 flex items-center justify-center">
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M8.228 9c.549-1.756 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"
                      />
                    </svg>
                  </div>
                ...
                <a
                  href="#"
                  className="inline-flex items-center gap-2 text-blue-600 mt-6 group-hover:text-blue-700 transition-colors font-medium"
                >
                  了解更多
                  <svg
                    className="w-4 h-4"
              ...
              <div className="group bg-white rounded-2xl p-8 hover:shadow-lg transition-all duration-300 border border-gray-200 card-hover">
                ...
                <a
                  href="#"
                  className="inline-flex items-center gap-2 text-purple-600 mt-6 group-hover:text-purple-700 transition-colors font-medium"
                >
                  了解更多
                  <svg
                    className="w-4 h-4"
              ...
              <div className="group bg-white rounded-2xl p-8 hover:shadow-lg transition-all duration-300 border border-gray-200 card-hover">
                ...
                <a
                  href="#"
                  className="inline-flex items-center gap-2 text-green-600 mt-6 group-hover:text-green-700 transition-colors font-medium"
                >
                  了解更多
                  <svg
                    className="w-4 h-4"
            ...
            <div className="max-w-4xl mx-auto px-4 mb-20">
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  ...
                  <div
                    key={index}
                    className="group bg-green-50 rounded-xl p-6 border border-green-200 hover:border-green-300 transition-all duration-300 shadow-sm hover:shadow-md"
                  >
              ...
              <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                ...
                <div className="mt-12 pt-8 border-t border-gray-200">
                  ...
                  <div className="flex flex-wrap justify-center gap-4">
                    {["大模型", "知识图谱", "多模态", "语音识别", "RAG"].map(
                      (item, index) => (
                        <div
                          key={index}
                          className="px-4 py-2 bg-gray-50 rounded-full border border-gray-200"
                        >
                          <span className="text-gray-700">{item}</span>
                        </div>
                      )
          ...
          <section className="py-20 relative bg-gray-50" id="technology">
            ...
            <div className="text-center mb-16 max-w-4xl mx-auto px-4">
              ...
              <p className="text-xl text-gray-600">打造全方位的智能服务体系</p>
            </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      {[
                        ...
                        <div
                          key={index}
                          className="bg-purple-50 rounded-lg p-4 group-hover:bg-purple-100 transition-colors border border-purple-100"
                        >
                          <div className="font-medium text-purple-700 mb-2">
                            {item.title}
                          </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      {[
                        ...
                        <div
                          key={index}
                          className="bg-blue-50 rounded-lg p-4 group-hover:bg-blue-100 transition-colors border border-blue-100"
                        >
                          <div className="font-medium text-blue-700 mb-2">
                            {item.title}
                          </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      {[
                        {
                          title: "知识图谱",
                          desc: "构建企业专属知识网络，实现关联推理",
                        },
                        {
                          title: "智能缓存",
                          desc: "热点问题秒级响应，降低95%延迟",
                        },
                        {
                          title: "持续更新",
                          desc: "自动从对话中提取新知识点，不断完善",
                        },
                      ].map((item, index) => (
                        <div
                          key={index}
                          className="bg-green-50 rounded-lg p-4 group-hover:bg-green-100 transition-colors border border-green-100"
                        >
                          <div className="font-medium text-green-700 mb-2">
                            {item.title}
                          </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      {[
                        ...
                        <div
                          key={index}
                          className="bg-orange-50 rounded-lg p-4 group-hover:bg-orange-100 transition-colors border border-orange-100"
                        >
                          <div className="font-medium text-orange-700 mb-2">
                            {item.title}
                          </div>
